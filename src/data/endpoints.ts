...
> = {
  ...
  Service: {
    ...
    update: "api/section/", // to update a brand
    read: "api/section/", // to get a brand
    fetchAll: "api/section?slug=service", // to fetch all brands
    operations: operations,
  },
  Contact: {
  ...
  User: {
    create: "api/auth/user/", // to create a user
    delete: "api/auth/user/", // to delete a user
    update: "api/auth/user/", // to update a user
    read: "api/auth/user/", // to get a user
    fetchAll: "api/auth/user/", // to fetch all Users
    operations: operations,
  },
  Role: {
